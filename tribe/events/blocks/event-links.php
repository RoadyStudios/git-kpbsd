...
<div class="tribe-block tribe-block__events-link">
	<?php if ( $has_google_cal ) : ?>
		<div class="tribe-block__btn--link tribe-block__events-gcal">
			...
			>
				<img src="<?php echo Tribe__Main::instance()->plugin_url  . 'src/modules/icons/link.svg'; ?>" alt="Add to Google Calendar icon" aria-label="Add to Google Calendar icon" />
	...
	<?php if ( $has_ical ) : ?>
		<div class="tribe-block__btn--link tribe-block__-events-ical">
			...
			>
				<img src="<?php echo Tribe__Main::instance()->plugin_url  . 'src/modules/icons/link.svg'; ?>" alt="Add to iCalendar icon" aria-label="Add to iCalendar icon" />
