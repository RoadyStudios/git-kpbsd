 ...
 * * `kpbsd_codebase()->is_primary_sidebar_active()`
 * * `kpbsd_codebase()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			[
				'name'          => esc_html__( 'Sidebar', 'kpbsd-codebase' ),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Add widgets here.', 'kpbsd-codebase' ),
		...
		register_sidebar(
			[
				'name'          => esc_html__( 'Footer widgets', 'kpbsd-codebase' ),
	...
	/**
	 * Checks whether the footer widget is active.
	 *
	 * @return bool True if the footer widget is active, false otherwise.
	 */
