 ...
 * * `kpbsd_codebase()->is_primary_nav_menu_active()`
 * * `kpbsd_codebase()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			[
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Primary', 'kpbsd-codebase' ),
			]
		);
	}
